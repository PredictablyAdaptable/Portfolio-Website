...
const UI = {
  en: {
    seoTitle: 'Writing & Insights — Andy Seo',
    seoDesc: 'Notes, articles, and insights on data science, marketing science, and growth experimentation.',
    overline: 'Blog',
    title: 'Writing & Insights',
    desc: 'Deep dives and quick notes on experimentation, data systems, and building growth loops that scale.',
  ...
  kr: {
    seoTitle: '블로그 & 인사이트 — 서형민',
    seoDesc: '데이터 사이언스, 마케팅 사이언스, 그리고 비즈니스 성장 실험에 대한 글과 인사이트.',
    overline: '블로그',
    title: '블로그 & 인사이트',
    desc: '실험과 측정, 그리고 확장 가능한 성장 시스템 구축에 대한 인사이트와 짧은 글.',
    searchPlaceholder: '글 검색',
    sortRecent: '최신순',
    sortAZ: '제목순 (A → Z)',
    ctaRead: '읽기',
    featured: '추천 글',
    stripQ: '데이터로 성장을 가속화하고 싶으신가요?',
    stripSee: '프로젝트 보기',
    stripTalk: '상담',
    new: '신규',
    mins: (m) => `${m} min`,
