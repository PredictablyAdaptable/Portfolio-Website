...
const UI = {
  en: {
    ...
    h1_b: 'Smarter. ',
    h1_c: 'Scale Faster. ',
    sub: 'I design and analyze experiments that drive measurable growth — from hypothesis to business impact. Geo-tests, incrementality, MMM, and predictive analytics, all built for decision-making speed.',
    bullets: [
      { icon: <RocketLaunchIcon />, label: 'weeks, not quarters' },
      { icon: <AutoAwesomeIcon />, label: 'MMM, experiments, causal inference' },
      { icon: <SecurityIcon />, label: 'data-driven, business-tested' },
    ],
  ...
  kr: {
    ...
    h1_b: '실험하고 ',
    h1_c: '더 빠르게 확장하세요. ',
    sub: '가설부터 비즈니스 임팩트까지 — 측정 가능한 성장을 이끄는 실험과 분석을 설계합니다. 지오테스트, 인크리멘털리티, MMM, 예측 분석 등 데이터 기반 의사결정을 위한 속도를 만듭니다.',
    bullets: [
      { icon: <RocketLaunchIcon />, label: '분기 단위가 아닌, 몇 주 안에 실행합니다' },
      { icon: <AutoAwesomeIcon />, label: '실험, MMM, 인과추론' },
      { icon: <SecurityIcon />, label: '데이터 기반, 비즈니스로 검증' },
    ],
    ctaPrimary: '무료 상담 예약',
